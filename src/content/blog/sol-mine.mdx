---
title: "Pipeline Reproductible pour l'Analyse du Microbiome Édaphique en Environnements Miniers"
date: "2026-09-27"
excerpt: "De l'Amplicon 16S à l'Inférence Statistique - Analyse bioinformatique complète du microbiome de sols miniers"
tags: ["Analyse bioinformatique", "Métagénomique", "QIIME 2", "phyloseq"]
...
![Graphique en boîte à moustaches comparant l'indice de diversité Alpha de Shannon entre les sols de sites miniers actifs et abandonnés, montrant des valeurs comprises entre 5.6 et 6.0.](/images/mine/alpha_diversity.png)
...
![Analyse en coordonnées principales (PCoA) basée sur la distance de Bray-Curtis, illustrant la dispersion des échantillons de sols miniers selon leur statut (actif ou abandonné).](/images/mine/beta_diversity.png)
...
![Diagramme en barres empilées montrant l'abondance relative des phylums bactériens et archéens (Proteobacteria, Acidobacteriota, Actinobacteriota, etc.) dans les échantillons de sols.](/images/mine/taxonomy_barplot.png)
