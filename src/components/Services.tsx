      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <ScrollFadeIn className="mb-20 text-center">
          ...
          <p className="font-body text-lg text-muted-foreground leading-[1.8] mt-6 max-w-[700px] mx-auto">
            Des solutions complètes pour vos projets de génomique, de l'extraction des données au rapport final.
          </p>
        </ScrollFadeIn>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {services.map((service, i) => (
            <ScrollFadeIn key={service.title} delay={i * 0.1}>
              <div className="rounded-xl border border-border/60 bg-card/30 p-8 flex flex-col h-full hover:border-primary/30 transition-colors duration-300">
