      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <motion.h1
            ...
            className="font-heading text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold leading-[1.08] mb-8 text-foreground"
          >
          ...
          <motion.p
            ...
            className="font-body text-lg md:text-xl text-muted-foreground mb-12 max-w-2xl mx-auto leading-[1.8]"
          >
        ...
        <motion.div
          ...
          className="mt-24 grid grid-cols-3 gap-8 max-w-xl mx-auto border-t border-border/40 pt-10 text-center"
        >
          {stats.map((stat) => (
            <div key={stat.label}>
